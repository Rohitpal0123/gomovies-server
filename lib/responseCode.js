module.exports = {
    ...
    INVALID_CODE: {
      ...
      code: 3002,
      message:
        "Response code and msg not mention. please select valid response code."
    },
    FAILED: {
      status_code: 200,
      code: 3003,
    ...
    LIMIT_EXCEEDED: {
      ...
      code: 3033,
      message:
        "You've exceeded the allowed limit please try again after some time"
    },
    ...
    AUTHENTICATOR_QR_GENERATED: {
      ...
      code: 2001,
      message:
        "Please scan the QRcode or enter the secret key in authenticator app and then enter the OTP received."
    },
    AUTHENTICATOR_CHECK_APP: {
      status_code: 200,
      code: 2001,
      message:
        "Please check the authenticator app and then enter the OTP received."
    },
    INVALID_BACKUP_CODE: {
      status_code: 401,
      code: 3046,
    ...
    SET_PASSWORD_BEFORE_LOGIN: {
      ...
      code: 3100,
      message:
        "Please set the password using the set password link sent to you before trying to login"
    },
    NO_SESSION_IDS_FOR_FORCE_LOGOUT: {
      status_code: 200,
      code: 3101,
      message:
        "There is no open session of the user you are trying to force logout"
    },
